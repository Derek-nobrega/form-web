...
<div class="wrapper">
    <form  action="CadastroServlet" class="ccform">
	...
	<br>
	<div class="ccfield-prepend">
		<span class="ccform-addon">Formação :</span>
		<div class="ccformfield">
			<select name="esco">
    ...
    <div class="ccfield-prepend">
        <input class="ccbtn" type="submit" value="Enviar">
    </div>
   
    <div class="ccfield-prepend">
        <input class="ccbtn" type="reset" value="Limpar">
    </div>
